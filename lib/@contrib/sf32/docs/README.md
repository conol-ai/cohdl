...
| --- | --- | --- | --- | --- |
| `ds0052-sf32lb52x-cn.pdf` | `SF32LB52X` device and ordering identities only; no part bindings | SiFli DS0052-SF32LB52X V0.1, 2024 | <https://www.sifli.com> | `68ad87f5846c47908614e980eaa56b0eea5e4ae036d0a5cee9357f80db7357c2` |

...
*Accepted via RFC-032, see RFC-032: Virtual connectivity instances + DR-038.*
...
RFC-032 adds explicit `#[virtual]` connectivity-only instances. They remain
fully checked and are centrally excluded before manufacturing IR; contradictory
manufacturing identity, placement, physics, or part binding is rejected.

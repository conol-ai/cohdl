...
Milestone (2026-07-16, second time this day): following footprint-naming research (STM32F103C8T6/RP2350A worked examples, cross-checked against IPC-7351B, JEDEC JESD30, and real KiCad/SnapEDA library names), Tony directed adopting IPC-7351 — not JEDEC JESD30, not an invented scheme — as CoHDL's canonical footprint naming practice. RFC-021 (IPC-7351 as the canonical footprint naming practice) is Accepted: footprint (RFC-017/018) gains a new, optional ipc_name: "..." field carrying an IPC-7351B-derived designator, checked for grammar well-formedness against a closed six-family-template set (QFP, QFN/SON, SOIC/SOP, SOT, BGA, CHIP/MELF) and, for geometrically-regular families, cross-checked against the footprint's own pad placements for pin-count/pitch consistency — closing the same class of "the name lies" gap RFC-018 closed for "the footprint lies." footprint_alias (Footprint Binding — Design) also gains a recognized ipc: key. Purely additive; no rename, no change to existing footprint/pad grammar. Backlog is now RFC-001 through RFC-021, all Accepted.

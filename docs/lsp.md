...
| `textDocument/definition` | A device/trait/fn/part/footprint/pad name at any use site (inst type, impl names, generic bounds, super-traits, calls, part device refs, footprint symbol refs, pad-placement symbols — RFC-016/017/018) resolves to its declaration |
